# PENN CYBERSECURITY FINAL

This repository outlines my final project for the University of Pennsylvania Cyber Security Boot Camp (Cohort that finished in May 2022). 

I acted as a 'security engineer' where I exploited vulnerable virtual machines. You will find deliverables outlining the Red Team Attack of two vulnerable target machines, the Blue Team Defense, and a PCAP analysis on Wireshark.

Below is a description of the entire unit created by Trilogy Education Services:
